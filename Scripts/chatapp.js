...
function ping() {
    ...
    tm = setTimeout(function() {
        ...
        document.getElementById('loginerror').innerText = "mahmoud";
    }, 7000);
}
/**
...
connection.onerror = function() {
    ...
    document.getElementById('loginerror').innerText = "Server";
    populate_error("server");
};
/**
...
async function creating_offer() {
    document.getElementById('dynamic_progress_text').setAttribute('data-loading-text', "");
    try {
...
function create_request_room_Modal(name) {
    var html = '<div class="vertical-alignment-helper">' +
        ...
        '<h4 class="modal-title" id="myModalLabel1"><strong> </strong></h4>' +
        '</div>' +
